...
final class RewardHaptics {
    static let shared = RewardHaptics()
    ...
    /// Begins a low-intensity continuous rumble (particles rising, paper
    /// curling, …). Defaults match the coins sequence; pass a lower intensity
    /// for subtler moments.
    func startContinuousLow(intensity: Float = 0.32, sharpness: Float = 0.18,
                            duration: Double = 30) {
